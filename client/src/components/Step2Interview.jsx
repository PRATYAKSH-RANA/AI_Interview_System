import maleVideo from "../assets/Video/Male_voice.mp4"
import femaleVideo from "../assets/Video/Female_voice.mp4"
...
const finishInterview = async () => {
    ...
    try {
      ...
      // Check what your backend is sending back in the console
      console.log("Finish Interview Server Response:", result.data);
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-emerald-600 via-white to-teal-100 flex items-center justify-center p-4 sm:p-6'>
      <div className='w-full max-w-[1400px] min-h-[80vh] bg-white rounded-3xl shadow-2xl border border-gray-200 flex flex-col lg:flex-row overflow-hidden'>
        ...
        <div className='w-full lg:w-[35%] bg-white flex flex-col items-center p-6 space-y-6 border-r border-gray-200'>
          ...
          <div className='w-full max-w-md bg-white border border-gray-200 rounded-2xl shadow-md p-6 space-y-5'>
            <div className='flex items-center justify-between'>
              <span className='text-sm font-semibold text-gray-500'>Interview Status</span>
              <span className='text-sm font-semibold text-emerald-600'>{isAIPlaying ? "AI SPEAKING" : "LISTENING"}</span>
            </div>
        ...
        <div className='flex-1 flex flex-col p-4 sm:p-6 md:p-8 relative'>
          ...
          {isIntroPhase ? (
            <div className='flex-1 flex items-center justify-center bg-gray-50 rounded-2xl border border-gray-200 p-8 text-center'>
              <p className='text-gray-500 text-lg font-medium'>Initializing your AI interview session...</p>
            </div>
          ) : (
            <>
              ...
              {!feedback ? (<div className='flex items-center gap-4 mt-6'>
                <motion.button 
                  ...
                  className={`w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center rounded-full shadow-lg transition ${
                    isMicOn ? 'bg-black text-white' : 'bg-red-500 text-white'
                  }`}
                >
