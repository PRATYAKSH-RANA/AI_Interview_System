...
function Step1SetUp({ onStart }) {
    ...
    const handleUploadResume = async () => {
        ...
        try {
            ...
            console.log('Resume Text:', result.data.resumeText);
            console.log('------------------------------');
            ...
            console.log("Error uploading/analyzing resume:", error);
            setAnalyzing(false);
        }
    }
    ...
    const handleStart = async () => {
        ...
        try {
            ...
            console.log("Error starting interview / generating questions:", error);
            setLoading(false);
        }
    }
        ...
        <motion.div
            ...
            <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
                ...
                <motion.div
                    ...
                    animate={{ x: 0, opacity: 1 }}
                    transition={{ duration: 0.7 }}
                    className="p-12 bg-white overflow-y-auto max-h-screen">
